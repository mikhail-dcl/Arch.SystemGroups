...
public readonly struct ArchSystemsWorldBuilder<T>
{
    ...
    public SystemGroupWorld Finish()
    {
        ...
        SimulationSystemGroup simulationSystemGroup = SimulationSystemGroup.Empty;
        PresentationSystemGroup presentationSystemGroup = PresentationSystemGroup.Empty;
        PostRenderingSystemGroup postRenderingSystemGroup = PostRenderingSystemGroup.Empty;
        PhysicsSystemGroup physicsSystemGroup = PhysicsSystemGroup.Empty;
        PostPhysicsSystemGroup postPhysicsSystemGroup = PostPhysicsSystemGroup.Empty;
        ...
        {
            var customGroup = _customGroups[systemType];
    ...
    private void CreateSystemGroup<TGroup>(ref TGroup group, Func<List<ISystem<float>>, TGroup> constructor) where TGroup : SystemGroup
    {
