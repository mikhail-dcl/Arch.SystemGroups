...
[UpdateInGroup(typeof(ThrottleSimulationGroup))]
public partial class ThrottleSimulationSystem : BaseSystem<TestWorld, float>
{
    public ThrottleSimulationSystem(TestWorld world) : base(world)
    {
    }
